...
prompt_entry = ctk.CTkTextbox(input_frame, height=5)
...
number_slider = ctk.CTkScrollbar(input_frame, from_=1, to=2)
number_slider.grid(row=11,column=1)
"""
#command=generate  
generate1_button = ctk.CTkButton(input_frame, text="OpenAI")
generate1_button.grid(row=11, column=0, columnspan=1, sticky="news", padx=10, pady=10)

generate2_button = ctk.CTkButton(input_frame, text="Gemini")
generate2_button.grid(row=11, column=1, columnspan=1, sticky="news", padx=10, pady=10)
